...
import static org.firstinspires.ftc.teamcode.aTestingAutonomous.gyro1;
import static org.firstinspires.ftc.teamcode.aTestingAutonomous.gyro2;



@TeleOp(name="Cheerios Teleop", group="OpMode")
public class AanoGyroTest extends OpMode {
    ...
    public void loop() {
        ...
        collectSpinnerM.setPower(gamepad2.left_trigger - gamepad2.right_trigger);
        ...
        if(dumping.milliseconds() < 100 || gamepad2.left_bumper){
            ...
            if (liftM.getCurrentPosition() < 1000){
                if (liftM.getCurrentPosition() > 800){
                    liftM.setPower(0.4);
                }
...
//                telemetry.addData("liftM pos", liftM.getCurrentPosition());
//                telemetry.update();
            }
            else{
                liftM.setPower(0.2);
...
//            }
//            else if (count >= 10){
//                sum = (angleTest[1] + angleTest[2] + angleTest[3] + angleTest[4] + angleTest[0] + angleTest[5] + angleTest[6] est[7] + angleTest[8] + angleTest[9])/10;
//                if(sum > angle){
//                    correct = sum - angle;
//                    angle = angle + correct;
//                }
